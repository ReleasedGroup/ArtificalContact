...
- The authenticated `/me` route includes the Sprint 2 composer preview panel for the reusable post and reply composer variants, plus a thread workspace that publishes real root posts to `POST /api/posts`.
