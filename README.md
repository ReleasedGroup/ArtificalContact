...
- `api/`: Azure Functions (Node 20, TypeScript) with feed, profile, post, thread, and reply HTTP endpoints plus the `usersByHandle` and reply-counter change-feed workers
