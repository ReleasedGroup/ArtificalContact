...
- Playwright covers the Sprint 6 search latency path: publishing from `/me` and polling `/api/search` until the new post becomes discoverable within five seconds
